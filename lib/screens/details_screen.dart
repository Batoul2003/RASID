      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            buildDetailTile('Ambient Temp', '${pvData["ambient_temp"]} °C'),
            buildDetailTile('String 1 Temp', '${pvData["string1_temp"]} °C'),
            buildDetailTile('String 2 Temp', '${pvData["string2_temp"]} °C'),
